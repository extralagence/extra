...
function extra_template_enqueue_scripts() {
	...
	// TWEENMAX
	wp_enqueue_script('tweenmax', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.13.1/TweenMax.min.js', null, null, true);
	// SCROLLTO
	wp_enqueue_script('tweenmax-scrollto', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.13.1/plugins/ScrollToPlugin.min.js', null, null, true);
	// JQUERY GSAP
	wp_enqueue_script('jquery-gsap', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.13.1/jquery.gsap.min.js', null, null, true);
	// DAGGABLE
	wp_enqueue_script('draggable', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.13.1/utils/Draggable.min.js', array('jquery', 'tweenmax'), null, true);
	// MOUSEWHEEL
