...
function extra_template_enqueue_scripts() {
	...
	// TWEENMAX
	wp_enqueue_script('tweenmax', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.11.0/TweenMax.min.js', null, null, true);
	// SCROLLTO
	wp_enqueue_script('tweenmax-scrollto', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.11.0/plugins/ScrollToPlugin.min.js', null, null, true);
	// JQUERY GSAP
	wp_enqueue_script('jquery-gsap', 'http://cdnjs.cloudflare.com/ajax/libs/gsap/1.11.0/jquery.gsap.min.js', null, null, true);
	// TOUCH SWIPE
	wp_enqueue_script('jquery-touchswipe', get_template_directory_uri() . '/assets/js/lib/jquery.touchSwipe.min.js', array('jquery'), null, true);
	// MOUSEWHEEL
