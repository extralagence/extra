...
//		);
		?>
		<div class="extra-accordion-wrapper">
			<?php $this->mb->the_field('title_0_'.$name); ?>
			...
			<?php $this->mb->the_field('content_0_'.$name); ?>
			<textarea
				class="extra-accordion-content"
				name="<?php $this->mb->the_name(); ?>">
			...
			<div id="wp-<?php echo $editor_id; ?>-wrap" class="wp-core-ui wp-editor-wrap tmce-active extra-accordion">
				...
				<div id="wp-<?php echo $editor_id; ?>-editor-container" class="wp-editor-container">
					<textarea
						class="wp-editor-area extra-accordion"
